...
To run this program locally:
  Clone the repository:
    ...
    git clone https://github.com/rns-code/FinalProject.git
    
On Windows/MAC:

Open the directory and run WanderingInTheWoods.bat

-OR-
    
Open it in your Java IDE (Eclipse, IntelliJ IDEA, or NetBeans).
Locate WanderingInTheWoods.java and run the program.
